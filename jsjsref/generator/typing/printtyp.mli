...
(* ARTHUR *)
val names : ((type_expr * string) list) ref
val delayed : (type_expr list) ref
val aliased : (type_expr list) ref
val add_delayed : type_expr -> unit
val is_aliased : type_expr -> bool
val add_alias : type_expr -> unit
val aliasable : type_expr -> bool
val is_non_gen : bool -> type_expr -> bool
