...
Inductive red : red_in (* input *) -> red_out -> Prop :=
  ...
  | red_spec_call_object_object_define_prop_2 :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (va : value (* input *)) (o : out) (y : (specret descriptor)),
        ...
        (* ------------------------------------------ *)
        (red (red_in_red_expr S C (spec_call_object_define_prop_2 l (out_ter S ((resvalue_value (value_prim (prim_string (x : string)))) : res)) va)) (red_out_red_expr o))
  ...
  | red_spec_call_object_object_define_prop_4 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red (red_in_red_expr S0 C (spec_call_object_define_prop_4 l (out_ter S (res_intro restype_normal resvalue_empty label_empty)))) (red_out_red_expr (out_ter S ((resvalue_value (value_object l)) : res))))
  ...
  | red_spec_call_object_seal_3 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (xs : (list prop_name) (* input *)) (x : prop_name (* input *)) (A : attributes (* input *)) (o1 : out) (o : out),
        ...
        (* ------------------------------------------ *)
        (red (red_in_red_expr S C (spec_call_object_seal_3 l x xs ((specret_val S0 (full_descriptor_some A)) : (specret full_descriptor)))) (red_out_red_expr (out_ter S ((resvalue_value (value_prim (prim_bool ((false : provide_this_flag) : bool)))) : res))))
  ...
  | red_spec_call_object_is_sealed_3_prop_configurable :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (xs : (list prop_name) (* input *)) (l : object_loc (* input *)),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red (red_in_red_expr S C (spec_call_object_is_sealed_3 l xs ((specret_val S0 (full_descriptor_some A)) : (specret full_descriptor)))) (red_out_red_expr (out_ter S ((resvalue_value (value_prim (prim_bool ((false : provide_this_flag) : bool)))) : res))))
