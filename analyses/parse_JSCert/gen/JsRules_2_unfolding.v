...
Inductive red_javascript : prog (* input *) -> out -> Prop :=
  ...
  | red_javascript_intro :
      forall (p : prog (* input *)) (o : out) (o1 : out),
        (* ========================================== *)
        (red_expr ((state_initial : state) : state) (((execution_ctx_initial ((prog_intro_strictness ((add_infos_prog strictness_false p) : prog)) : strictness_flag)) : execution_ctx) : execution_ctx) ((spec_binding_inst (codetype_global : codetype) (None : (option object_loc)) (((add_infos_prog strictness_false p) : prog) : prog) (nil : (list value))) : ext_expr) (o1 : out)) ->
        (red_prog ((state_initial : state) : state) (((execution_ctx_initial ((prog_intro_strictness ((add_infos_prog strictness_false p) : prog)) : strictness_flag)) : execution_ctx) : execution_ctx) ((javascript_1 (o1 : out) (((add_infos_prog strictness_false p) : prog) : prog)) : ext_prog) (o : out)) ->
        (* ------------------------------------------ *)
...
with red_prog : state (* input *) -> execution_ctx (* input *) -> ext_prog (* input *) -> out -> Prop :=
  ...
  | red_javascript_intro_1 :
      forall (S : state (* input *)) (S' : state (* input *)) (C : execution_ctx (* input *)) (p : prog (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_prog (S : state) (C : execution_ctx) ((javascript_1 ((out_void (S' : state)) : out) (p : prog)) : ext_prog) (o : out))
  ...
  | red_prog_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (R : res (* input *)) (rv : resvalue (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_prog (S0 : state) (C : execution_ctx) ((prog_2 (rv : resvalue) ((out_ter (S : state) (R : res)) : out)) : ext_prog) ((out_ter (S : state) (((res_overwrite_value_if_empty (rv : resvalue) (R : res)) : res) : res)) : out))
...
with red_stat : state (* input *) -> execution_ctx (* input *) -> ext_stat (* input *) -> out -> Prop :=
  ...
  | red_stat_block_2_not_throw :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (R : res (* input *)) (rv : resvalue (* input *)),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_block_2 (rv : resvalue) ((out_ter (S : state) (R : res)) : out)) : ext_stat) ((out_ter (S : state) (((res_overwrite_value_if_empty (rv : resvalue) (R : res)) : res) : res)) : out))
  ...
  | red_stat_var_decl_item_1 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (x : prop_name (* input *)) (e : expr (* input *)) (r : ref (* input *)) (y1 : (specret value)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_var_decl_item_1 (x : string) ((ret S r) : (specret ref)) (e : expr)) : ext_stat) (o : out))
  ...
  | red_stat_var_decl_item_2 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (r : ref (* input *)) (v : value (* input *)) (o : out) (o1 : out) (x : prop_name (* input *)),
        ...
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_var_decl_item_2 (x : string) (r : ref) ((ret S v) : (specret value))) : ext_stat) (o : out))

  | red_stat_var_decl_item_3 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (x : prop_name (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_var_decl_item_3 (x : string) ((out_void (S : state)) : out)) : ext_stat) ((out_ter (S : state) (x : res)) : out))
  ...
  | red_stat_expr_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_expr_1 ((ret S v) : (specret value))) : ext_stat) ((out_ter (S : state) (v : res)) : out))
  ...
  | red_stat_if_1_true :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (t2 : stat (* input *)) (t3opt : (option stat) (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_if_1 ((vret S true) : (specret value)) (t2 : stat) (t3opt : (option stat))) : ext_stat) (o : out))
  ...
  | red_stat_if_1_false :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (t2 : stat (* input *)) (t3 : stat (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_if_1 ((vret S false) : (specret value)) (t2 : stat) ((Some t3) : (option stat))) : ext_stat) (o : out))

  | red_stat_if_1_false_implicit :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (t2 : stat (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_if_1 ((vret S false) : (specret value)) (t2 : stat) (None : (option stat))) : ext_stat) ((out_ter (S : state) (resvalue_empty : res)) : out))
  ...
  | red_stat_do_while_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (t1 : stat (* input *)) (e2 : expr (* input *)) (rv_old : resvalue (* input *)) (R : res (* input *)) (o : out),
        (* ========================================== *)
        (red_stat (S : state) (C : execution_ctx) ((stat_do_while_3 (labs : label_set) (t1 : stat) (e2 : expr) (((ifb ((res_value (R : res)) = (resvalue_empty : resvalue)) then (rv_old : resvalue) else (res_value (R : res))) : resvalue) : resvalue) (R : res)) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_stat_do_while_7_false :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (t1 : stat (* input *)) (e2 : expr (* input *)) (rv : resvalue (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_do_while_7 (labs : label_set) (t1 : stat) (e2 : expr) (rv : resvalue) ((vret S false) : (specret value))) : ext_stat) ((out_ter (S : state) (rv : res)) : out))
  ...
  | red_stat_do_while_7_true :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (t1 : stat (* input *)) (e2 : expr (* input *)) (rv : resvalue (* input *)) (o : out),
        ...
        (red_stat (S : state) (C : execution_ctx) ((stat_do_while_1 (labs : label_set) (t1 : stat) (e2 : expr) (rv : resvalue)) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_do_while_7 (labs : label_set) (t1 : stat) (e2 : expr) (rv : resvalue) ((vret S true) : (specret value))) : ext_stat) (o : out))
  ...
  | red_stat_while_2_false :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (e1 : expr (* input *)) (t2 : stat (* input *)) (rv : resvalue (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_while_2 (labs : label_set) (e1 : expr) (t2 : stat) (rv : resvalue) ((vret S false) : (specret value))) : ext_stat) ((out_ter (S : state) (rv : res)) : out))
  ...
  | red_stat_while_2_true :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (e1 : expr (* input *)) (t2 : stat (* input *)) (rv : resvalue (* input *)) (o1 : out) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_while_2 (labs : label_set) (e1 : expr) (t2 : stat) (rv : resvalue) ((vret S true) : (specret value))) : ext_stat) (o : out))
  ...
  | red_stat_while_3 :
      forall (rv : resvalue (* input *)) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (e1 : expr (* input *)) (t2 : stat (* input *)) (R : res (* input *)) (o : out),
        (* ========================================== *)
        (red_stat (S : state) (C : execution_ctx) ((stat_while_4 (labs : label_set) (e1 : expr) (t2 : stat) (((ifb ((res_value (R : res)) <> (resvalue_empty : resvalue)) then ((res_value (R : res)) : resvalue) else rv) : resvalue) : resvalue) (R : res)) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_stat_for_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (v : value (* input *)) (eo2 : (option expr) (* input *)) (eo3 : (option expr) (* input *)) (t : stat (* input *)) (o : out),
        ...
        (red_stat (S : state) (C : execution_ctx) ((stat_for_2 (labs : label_set) (resvalue_empty : resvalue) (eo2 : (option expr)) (eo3 : (option expr)) (t : stat)) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_for_1 (labs : label_set) ((ret S v) : (specret value)) (eo2 : (option expr)) (eo3 : (option expr)) (t : stat)) : ext_stat) (o : out))
  ...
  | red_stat_for_3_false :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (rv : resvalue (* input *)) (e2 : expr (* input *)) (eo3 : (option expr) (* input *)) (t : stat (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_for_3 (labs : label_set) (rv : resvalue) (e2 : expr) ((vret S false) : (specret value)) (eo3 : (option expr)) (t : stat)) : ext_stat) ((out_ter (S : state) (rv : res)) : out))
  ...
  | red_stat_for_3_not_false :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (rv : resvalue (* input *)) (e2 : expr (* input *)) (v : value (* input *)) (eo3 : (option expr) (* input *)) (t : stat (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_for_3 (labs : label_set) (rv : resvalue) (e2 : expr) ((vret S v) : (specret value)) (eo3 : (option expr)) (t : stat)) : ext_stat) (o : out))
  ...
  | red_stat_for_5 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (rv : resvalue (* input *)) (R : res (* input *)) (eo2 : (option expr) (* input *)) (eo3 : (option expr) (* input *)) (t : stat (* input *)) (o : out),
        (* ========================================== *)
        (red_stat (S : state) (C : execution_ctx) ((stat_for_6 (labs : label_set) (((ifb ((res_value (R : res)) <> (resvalue_empty : resvalue)) then ((res_value (R : res)) : resvalue) else rv) : resvalue) : resvalue) (eo2 : (option expr)) (eo3 : (option expr)) (t : stat) (R : res)) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_stat_for_9 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (labs : label_set (* input *)) (rv : resvalue (* input *)) (v : value (* input *)) (eo2 : (option expr) (* input *)) (e3 : expr (* input *)) (t : stat (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_for_9 (labs : label_set) (rv : resvalue) (eo2 : (option expr)) (e3 : expr) ((vret S v) : (specret value)) (t : stat)) : ext_stat) (o : out))
  ...
  | red_stat_return_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_return_1 ((ret S v) : (specret value))) : ext_stat) ((out_ter (S : state) ((res_return (v : resvalue)) : res)) : out))
  ...
  | red_stat_with_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (t2 : stat (* input *)) (l : object_loc (* input *)) (o : out) (lex : lexical_env),
        ...
        (* ========================================== *)
        (red_stat ((snd (lexical_env_alloc_object S lex l provide_this_true)) : state) (((execution_ctx_with_lex (C : execution_ctx) ((fst (lexical_env_alloc_object S lex l provide_this_true)) : lexical_env)) : execution_ctx) : execution_ctx) (t2 : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_with_1 (t2 : stat) ((vret S l) : (specret value))) : ext_stat) (o : out))
  ...
  | red_stat_switch_1_nodefault :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (vi : value (* input *)) (o : out) (o1 : out) (scs : (list switchclause) (* input *)) (labs : label_set (* input *)),
        ...
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_switch_1 ((ret S vi) : (specret value)) (labs : label_set) ((switchbody_nodefault (scs : (list switchclause))) : switchbody)) : ext_stat) (o : out))
  ...
  | red_stat_switch_1_default :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (o : out) (o1 : out) (vi : value (* input *)) (scs1 : (list switchclause) (* input *)) (scs2 : (list switchclause) (* input *)) (ts1 : (list stat) (* input *)) (labs : label_set (* input *)),
        ...
        (red_stat (S : state) (C : execution_ctx) ((stat_switch_2 (o1 : out) (labs : label_set)) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_switch_1 ((ret S vi) : (specret value)) (labs : label_set) ((switchbody_withdefault (scs1 : (list switchclause)) (ts1 : (list stat)) (scs2 : (list switchclause))) : switchbody)) : ext_stat) (o : out))
  ...
  | red_stat_switch_2_break :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (rv : resvalue) (lab : label) (labs : label_set (* input *)),
        (res_label_in ((res_intro (restype_break : restype) (rv : resvalue) (lab : label)) : res) labs) ->
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_switch_2 ((out_ter (S : state) (((res_intro (restype_break : restype) (rv : resvalue) (lab : label)) : res) : res)) : out) (labs : label_set)) : ext_stat) ((out_ter (S : state) ((res_normal (rv : resvalue)) : res)) : out))
  ...
  | red_stat_switch_nodefault_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vi : value (* input *)) (v1 : value (* input *)) (rv : resvalue (* input *)) (ts : (list stat) (* input *)) (scs : (list switchclause) (* input *)) (o : out),
        (* ========================================== *)
        (red_stat (S : state) (C : execution_ctx) ((stat_switch_nodefault_3 (((strict_equality_test (v1 : value) (vi : value)) : bool) : bool) (vi : value) (rv : resvalue) (ts : (list stat)) (scs : (list switchclause))) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_switch_nodefault_2 ((ret S v1) : (specret value)) (vi : value) (rv : resvalue) (ts : (list stat)) (scs : (list switchclause))) : ext_stat) (o : out))
  ...
  | red_stat_switch_nodefault_6_normal :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (R : res (* input *)) (rv : resvalue (* input *)) (scs : (list switchclause) (* input *)) (o : out),
        (* ========================================== *)
        (red_stat (S : state) (C : execution_ctx) ((stat_switch_nodefault_5 (((ifb ((res_value (R : res)) <> (resvalue_empty : resvalue)) then ((res_value (R : res)) : resvalue) else rv) : resvalue) : resvalue) (scs : (list switchclause))) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_stat_switch_nodefault_6_abrupt :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (R : res (* input *)) (scs : (list switchclause) (* input *)) (rv : resvalue (* input *)),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_switch_nodefault_6 (rv : resvalue) ((out_ter (S : state) (R : res)) : out) (scs : (list switchclause))) : ext_stat) ((out_ter (S : state) (((res_overwrite_value_if_empty (rv : resvalue) (R : res)) : res) : res)) : out))
  ...
  | red_stat_switch_default_A_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vi : value (* input *)) (v1 : value (* input *)) (rv : resvalue (* input *)) (ts : (list stat) (* input *)) (scs : (list switchclause) (* input *)) (ts1 : (list stat) (* input *)) (scs2 : (list switchclause) (* input *)) (o : out),
        (* ========================================== *)
        (red_stat (S : state) (C : execution_ctx) ((stat_switch_default_A_3 (((strict_equality_test (v1 : value) (vi : value)) : bool) : bool) (vi : value) (rv : resvalue) (ts : (list stat)) (scs : (list switchclause)) (ts1 : (list stat)) (scs2 : (list switchclause))) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_switch_default_A_2 ((ret S v1) : (specret value)) (vi : value) (rv : resvalue) (ts : (list stat)) (scs : (list switchclause)) (ts1 : (list stat)) (scs2 : (list switchclause))) : ext_stat) (o : out))
  ...
  | red_stat_switch_default_A_5 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (vi : value (* input *)) (rv0 : resvalue (* input *)) (rv : resvalue (* input *)) (scs : (list switchclause) (* input *)) (scs2 : (list switchclause) (* input *)) (ts1 : (list stat) (* input *)) (o : out),
        (* ========================================== *)
        (red_stat (S : state) (C : execution_ctx) ((stat_switch_default_A_1 (true : bool) (vi : value) (((ifb (rv <> (resvalue_empty : resvalue)) then (rv : resvalue) else rv0) : resvalue) : resvalue) (scs : (list switchclause)) (ts1 : (list stat)) (scs2 : (list switchclause))) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_stat_switch_default_B_2 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (vi : value (* input *)) (v1 : value (* input *)) (rv : resvalue (* input *)) (ts : (list stat) (* input *)) (scs : (list switchclause) (* input *)) (ts1 : (list stat) (* input *)) (o : out),
        (* ========================================== *)
        (red_stat (S : state) (C : execution_ctx) ((stat_switch_default_B_3 (((strict_equality_test (v1 : value) (vi : value)) : bool) : bool) (vi : value) (rv : resvalue) (ts : (list stat)) (ts1 : (list stat)) (scs : (list switchclause))) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_switch_default_B_2 ((ret S v1) : (specret value)) (vi : value) (rv : resvalue) (ts : (list stat)) (ts1 : (list stat)) (scs : (list switchclause))) : ext_stat) (o : out))
  ...
  | red_stat_switch_default_8_normal :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (rv0 : resvalue (* input *)) (rv : resvalue (* input *)) (scs : (list switchclause) (* input *)) (o : out),
        (* ========================================== *)
        (red_stat (S : state) (C : execution_ctx) ((stat_switch_default_7 (((ifb (rv <> (resvalue_empty : resvalue)) then (rv : resvalue) else rv0) : resvalue) : resvalue) (scs : (list switchclause))) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_stat_label_1_break_eq :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (rv : resvalue) (lab : label (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_label_1 (lab : label) ((out_ter (S : state) (((res_intro (restype_break : restype) (rv : resvalue) (lab : label)) : res) : res)) : out)) : ext_stat) ((out_ter (S : state) ((res_normal (rv : resvalue)) : res)) : out))
  ...
  | red_stat_throw_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_throw_1 ((ret S v) : (specret value))) : ext_stat) ((out_ter (S : state) ((res_throw (v : resvalue)) : res)) : out))
  ...
  | red_stat_try_1_throw_catch :
      forall (v : value) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (lex : lexical_env) (oldlex : (list env_loc)) (L : env_loc) (x : prop_name (* input *)) (R : res (* input *)) (t1 : stat (* input *)) (fo : (option stat) (* input *)) (o1 : out) (o : out),
        ((res_type (R : res)) = (restype_throw : restype)) ->
        ((lex : lexical_env) = (execution_ctx_lexical_env (C : execution_ctx))) ->
        (((fst (lexical_env_alloc_decl S lex)) : (list env_loc)) = (L :: (oldlex : (list env_loc)))) ->
        ((res_value (R : res)) = ((resvalue_value (v : value)) : resvalue)) ->
        (* ========================================== *)
        (red_expr ((snd (lexical_env_alloc_decl S lex)) : state) (C : execution_ctx) ((spec_env_record_create_set_mutable_binding (L : env_loc) (x : prop_name) (None : (option bool)) (v : value) (throw_irrelevant : bool)) : ext_expr) (o1 : out)) ->
        (red_stat ((snd (lexical_env_alloc_decl S lex)) : state) (C : execution_ctx) ((stat_try_2 (o1 : out) ((fst (lexical_env_alloc_decl S lex)) : lexical_env) (t1 : stat) (fo : (option stat))) : ext_stat) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_stat_try_2_catch :
      forall (C : execution_ctx (* input *)) (S0 : state (* input *)) (S : state (* input *)) (lex' : lexical_env (* input *)) (t1 : stat (* input *)) (fo : (option stat) (* input *)) (o : out) (o1 : out),
        ...
        (* ------------------------------------------ *)
        (red_stat (S0 : state) (C : execution_ctx) ((stat_try_2 ((out_void (S : state)) : out) (lex' : lexical_env) (t1 : stat) (fo : (option stat))) : ext_stat) (o : out))
...
with red_expr : state (* input *) -> execution_ctx (* input *) -> ext_expr (* input *) -> out -> Prop :=
  ...
  | red_expr_this :
      forall (S : state (* input *)) (C : execution_ctx (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) (expr_this : ext_expr) ((out_ter (S : state) (((execution_ctx_this_binding (C : execution_ctx)) : value) : res)) : out))
  ...
  | red_expr_identifier_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (r : ref (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_identifier_1 ((ret S r) : (specret ref))) : ext_expr) ((out_ter (S : state) (r : res)) : out))

  | red_expr_literal :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (i : literal (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((expr_literal (i : literal)) : ext_expr) ((out_ter (S : state) (((convert_literal_to_prim i) : value) : res)) : out))
  ...
  | red_expr_object_1_cons :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (pn : propname (* input *)) (pb : propbody (* input *)) (pds : propdefs (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((expr_object_2 (l : object_loc) (((string_of_propname (pn : propname)) : prop_name) : string) (pb : propbody) (pds : propdefs)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_expr_object_3_val :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)) (o : out) (pds : propdefs (* input *)),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((expr_object_4 (l : object_loc) (x : string) (((attributes_data_intro (v : value) (true : bool) (true : bool) (true : bool)) : attributes) : attributes) (pds : propdefs)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_object_3_val (l : object_loc) (x : string) ((ret S v) : (specret value)) (pds : propdefs)) : ext_expr) (o : out))
  ...
  | red_expr_object_3_get :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)) (pds : propdefs (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((expr_object_4 (l : object_loc) (x : string) (((attributes_accessor_intro (v : value) (undef : value) (true : bool) (true : bool)) : attributes) : attributes) (pds : propdefs)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_expr_object_3_set :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)) (pds : propdefs (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((expr_object_4 (l : object_loc) (x : string) (((attributes_accessor_intro (undef : value) (v : value) (true : bool) (true : bool)) : attributes) : attributes) (pds : propdefs)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_expr_object_4 :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (pds : propdefs (* input *)) (o : out) (o1 : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) (x : prop_name) (A : descriptor) (false : bool)) : ext_expr) (o1 : out)) ->
        (red_expr (S : state) (C : execution_ctx) ((expr_object_5 (l : object_loc) (pds : propdefs) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((expr_object_4 (l : object_loc) (x : string) (A : attributes) (pds : propdefs)) : ext_expr) (o : out))
  ...
  | red_expr_access_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v1 : value (* input *)) (e2 : expr (* input *)) (y1 : (specret value)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_access_1 ((ret S v1) : (specret value)) (e2 : expr)) : ext_expr) (o : out))
  ...
  | red_expr_access_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v1 : value (* input *)) (v2 : value (* input *)) (o1 : out) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_access_2 (v1 : value) ((ret S v2) : (specret value))) : ext_expr) (o : out))
  ...
  | red_expr_access_3 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v1 : value (* input *)) (v2 : value (* input *)) (o1 : out) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_access_3 (v1 : value) ((out_void (S : state)) : out) (v2 : value)) : ext_expr) (o : out))

  | red_expr_access_4 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v1 : value (* input *)) (x : prop_name (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_access_4 (v1 : value) ((out_ter (S : state) (x : res)) : out)) : ext_expr) ((out_ter (S : state) (((ref_create_value v1 x (execution_ctx_strict (C : execution_ctx))) : ref) : res)) : out))
  ...
  | red_expr_new_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (e2s : (list expr) (* input *)) (v : value (* input *)) (y1 : (specret (list value))) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_new_1 ((ret S v) : (specret value)) (e2s : (list expr))) : ext_expr) (o : out))
  ...
  | red_expr_new_2_type_error_not_object :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (o : out) (v : value (* input *)) (vs : (list value) (* input *)),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_new_2 (v : value) ((ret S vs) : (specret (list value)))) : ext_expr) (o : out))
  ...
  | red_expr_new_2_type_error_no_construct :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (o : out) (l : object_loc (* input *)) (vs : (list value) (* input *)),
        ...
        (red_expr (S : state) (C : execution_ctx) ((spec_error (native_error_type : native_error)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_new_2 ((value_object (l : object_loc)) : value) ((ret S vs) : (specret (list value)))) : ext_expr) (o : out))
  ...
  | red_expr_call_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (rv : resvalue (* input *)) (v : value (* input *)) (e2s : (list expr) (* input *)) (is_eval_direct : bool (* input *)) (y1 : (specret (list value))) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_call_2 (rv : res) (is_eval_direct : bool) (e2s : (list expr)) ((ret S v) : (specret value))) : ext_expr) (o : out))
  ...
  | red_expr_call_3 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (o : out) (rv : resvalue (* input *)) (v : value (* input *)) (is_eval_direct : bool (* input *)) (vs : (list value) (* input *)),
        ...
        (red_expr (S : state) (C : execution_ctx) ((spec_error (native_error_type : native_error)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_call_3 (rv : res) (v : value) (is_eval_direct : bool) ((ret S vs) : (specret (list value)))) : ext_expr) (o : out))
  ...
  | red_expr_call_3_callable :
      forall (l : object_loc (* input *)) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (o : out) (rv : resvalue (* input *)) (is_eval_direct : bool (* input *)) (vs : (list value) (* input *)),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_call_3 (rv : res) ((value_object (l : object_loc)) : value) (is_eval_direct : bool) ((ret S vs) : (specret (list value)))) : ext_expr) (o : out))
  ...
  | red_expr_function_named :
      forall (L : env_loc) (lextail : (list env_loc)) (E : env_record) (o1 : out) (S : state (* input *)) (C : execution_ctx (* input *)) (s : string (* input *)) (args : (list string) (* input *)) (bd : funcbody (* input *)) (o : out),
        (((fst (lexical_env_alloc_decl S (execution_ctx_lexical_env (C : execution_ctx)))) : (list env_loc)) = (L :: (lextail : (list env_loc)))) ->
        (env_record_binds ((snd (lexical_env_alloc_decl S (execution_ctx_lexical_env (C : execution_ctx)))) : state) (L : env_loc) (E : env_record)) ->
        (* ========================================== *)
        (red_expr ((snd (lexical_env_alloc_decl S (execution_ctx_lexical_env (C : execution_ctx)))) : state) (C : execution_ctx) ((spec_env_record_create_immutable_binding (L : env_loc) (s : prop_name)) : ext_expr) (o1 : out)) ->
        (red_expr ((snd (lexical_env_alloc_decl S (execution_ctx_lexical_env (C : execution_ctx)))) : state) (C : execution_ctx) ((expr_function_1 (s : string) (args : (list string)) (bd : funcbody) (L : env_loc) ((fst (lexical_env_alloc_decl S (execution_ctx_lexical_env (C : execution_ctx)))) : lexical_env) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_expr_function_named_1 :
      forall (o1 : out) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (s : string (* input *)) (args : (list string) (* input *)) (bd : funcbody (* input *)) (L : env_loc (* input *)) (scope : lexical_env (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_function_1 (s : string) (args : (list string)) (bd : funcbody) (L : env_loc) (scope : lexical_env) ((out_void (S : state)) : out)) : ext_expr) (o : out))
  ...
  | red_expr_function_named_3 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_function_3 (l : object_loc) ((out_void (S : state)) : out)) : ext_expr) ((out_ter (S : state) (l : res)) : out))
  ...
  | red_expr_prepost_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (rv : resvalue (* input *)) (op : unary_op (* input *)) (v : value (* input *)) (o1 : out) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_prepost_2 (op : unary_op) (rv : res) ((ret S v) : (specret value))) : ext_expr) (o : out))
  ...
  | red_expr_prepost_3 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (rv : resvalue (* input *)) (op : unary_op (* input *)) (number_op : (number -> number)) (is_pre : bool) (n1 : number (* input *)) (o1 : out) (o : out),
        ...
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_put_value (rv : resvalue) (((number_op n1) : number) : value)) : ext_expr) (o1 : out)) ->
        (red_expr (S : state) (C : execution_ctx) ((expr_prepost_4 (((prim_number ((ifb is_pre then (((number_op n1) : number) : number) else n1) : number)) : value) : value) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_expr_prepost_4 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_prepost_4 (v : value) ((out_void (S : state)) : out)) : ext_expr) ((out_ter (S : state) (v : res)) : out))
  ...
  | red_expr_unary_op_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (op : unary_op (* input *)) (v : value (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_unary_op_1 (op : unary_op) ((ret S v) : (specret value))) : ext_expr) (o : out))
  ...
  | red_expr_typeof_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_typeof_2 ((ret S v) : (specret value))) : ext_expr) ((out_ter (S : state) (((typeof_value (S : state) (v : value)) : string) : res)) : out))
  ...
  | red_expr_unary_op_bitwise_not_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (k : int (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_unary_op_bitwise_not_1 ((ret S k) : (specret int))) : ext_expr) ((out_ter (S : state) (((JsNumber.of_int (JsNumber.int32_bitwise_not k)) : number) : res)) : out))
  ...
  | red_expr_binary_op_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (op : binary_op (* input *)) (v1 : value (* input *)) (e2 : expr (* input *)) (y1 : (specret value)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_binary_op_1 (op : binary_op) ((ret S v1) : (specret value)) (e2 : expr)) : ext_expr) (o : out))
  ...
  | red_expr_binary_op_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (op : binary_op (* input *)) (v1 : value (* input *)) (v2 : value (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_binary_op_2 (op : binary_op) (v1 : value) ((ret S v2) : (specret value))) : ext_expr) (o : out))
  ...
  | red_expr_binary_op_add_1_string :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v1 : value (* input *)) (v2 : value (* input *)) (y1 : (specret (value * value))) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_binary_op_add_1 ((ret S (v1, v2)) : (specret (value * value)))) : ext_expr) (o : out))

  | red_expr_binary_op_add_string_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (s1 : string (* input *)) (s2 : string (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_binary_op_add_string_1 ((ret S ((value_prim (s1 : prim)), (value_prim (s2 : prim)))) : (specret (value * value)))) : ext_expr) ((out_ter (S : state) (((String.append s1 s2) : string) : res)) : out))
  ...
  | red_expr_puremath_op_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (F : (number -> (number -> number)) (* input *)) (n1 : number (* input *)) (n2 : number (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_puremath_op_1 (F : (number -> (number -> number))) ((ret S ((value_prim (n1 : prim)), (value_prim (n2 : prim)))) : (specret (value * value)))) : ext_expr) ((out_ter (S : state) (((F n1 n2) : number) : res)) : out))
  ...
  | red_expr_shift_op_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (F : (int -> (int -> int)) (* input *)) (k1 : int (* input *)) (v2 : value (* input *)) (y1 : (specret int)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_shift_op_1 (F : (int -> (int -> int))) ((ret S k1) : (specret int)) (v2 : value)) : ext_expr) (o : out))

  | red_expr_shift_op_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (k1 : int (* input *)) (k2 : int (* input *)) (F : (int -> (int -> int)) (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_shift_op_2 (F : (int -> (int -> int))) (k1 : int) ((ret S k2) : (specret int))) : ext_expr) ((out_ter (S : state) (((JsNumber.of_int (F k1 (JsNumber.modulo_32 k2))) : number) : res)) : out))
  ...
  | red_expr_inequality_op_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (w1 : prim (* input *)) (w2 : prim (* input *)) (b_swap : bool (* input *)) (b_neg : bool (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_inequality_op_2 (b_swap : bool) (b_neg : bool) ((ret S ((value_prim (w1 : prim)), (value_prim (w2 : prim)))) : (specret (value * value)))) : ext_expr) ((out_ter (S : state) (((ifb (((inequality_test_primitive ((fst ((ifb b_swap then ((w2, w1) : (prim * prim)) else (w1, w2)) : (prim * prim))) : prim) ((snd ((ifb b_swap then ((w2, w1) : (prim * prim)) else (w1, w2)) : (prim * prim))) : prim)) : prim) = (prim_undef : prim)) then (false : prim) else (ifb (((b_neg = true) : Prop) /\ ((((inequality_test_primitive ((fst ((ifb b_swap then ((w2, w1) : (prim * prim)) else (w1, w2)) : (prim * prim))) : prim) ((snd ((ifb b_swap then ((w2, w1) : (prim * prim)) else (w1, w2)) : (prim * prim))) : prim)) : prim) = true) : Prop)) then (false : prim) else (ifb (((b_neg = true) : Prop) /\ ((((inequality_test_primitive ((fst ((ifb b_swap then ((w2, w1) : (prim * prim)) else (w1, w2)) : (prim * prim))) : prim) ((snd ((ifb b_swap then ((w2, w1) : (prim * prim)) else (w1, w2)) : (prim * prim))) : prim)) : prim) = false) : Prop)) then (true : prim) else ((inequality_test_primitive ((fst ((ifb b_swap then ((w2, w1) : (prim * prim)) else (w1, w2)) : (prim * prim))) : prim) ((snd ((ifb b_swap then ((w2, w1) : (prim * prim)) else (w1, w2)) : (prim * prim))) : prim)) : prim)))) : prim) : res)) : out))
  ...
  | red_spec_equal :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (v1 : value (* input *)) (v2 : value (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_equal_1 (((type_of v1) : type) : type) (((type_of v2) : type) : type) (v1 : value) (v2 : value)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_equal (v1 : value) (v2 : value)) : ext_expr) (o : out))
  ...
  | red_spec_equal_1_same_type :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (v1 : value (* input *)) (v2 : value (* input *)) (ty : type (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_equal_1 (ty : type) (ty : type) (v1 : value) (v2 : value)) : ext_expr) ((out_ter (S : state) (((equality_test_for_same_type (ty : type) (v1 : value) (v2 : value)) : bool) : res)) : out))
  ...
  | red_expr_binary_op_strict_equal :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (v1 : value (* input *)) (v2 : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((expr_binary_op_3 (binary_op_strict_equal : binary_op) (v1 : value) (v2 : value)) : ext_expr) ((out_ter (S : state) (((strict_equality_test (v1 : value) (v2 : value)) : bool) : res)) : out))

  | red_expr_binary_op_strict_disequal :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (v1 : value (* input *)) (v2 : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((expr_binary_op_3 (binary_op_strict_disequal : binary_op) (v1 : value) (v2 : value)) : ext_expr) ((out_ter (S : state) (((negb (strict_equality_test (v1 : value) (v2 : value))) : bool) : res)) : out))
  ...
  | red_expr_bitwise_op_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (F : (int -> (int -> int)) (* input *)) (k1 : int (* input *)) (v2 : value (* input *)) (y1 : (specret int)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_bitwise_op_1 (F : (int -> (int -> int))) ((ret S k1) : (specret int)) (v2 : value)) : ext_expr) (o : out))
  ...
  | red_expr_bitwise_op_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (F : (int -> (int -> int)) (* input *)) (k1 : int (* input *)) (k2 : int (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_bitwise_op_2 (F : (int -> (int -> int))) (k1 : int) ((ret S k2) : (specret int))) : ext_expr) ((out_ter (S : state) (((JsNumber.of_int (F k1 k2)) : number) : res)) : out))
  ...
  | red_expr_lazy_op_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (b_ret : bool (* input *)) (e2 : expr (* input *)) (v1 : value (* input *)) (o1 : out) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_lazy_op_1 (b_ret : bool) ((ret S v1) : (specret value)) (e2 : expr)) : ext_expr) (o : out))
  ...
  | red_expr_lazy_op_2_first :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (b_ret : bool (* input *)) (e2 : expr (* input *)) (v1 : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_lazy_op_2 (b_ret : bool) (v1 : value) ((out_ter (S : state) ((b_ret : bool) : res)) : out) (e2 : expr)) : ext_expr) ((out_ter (S : state) (v1 : res)) : out))
  ...
  | red_expr_lazy_op_2_second_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_lazy_op_2_1 ((ret S v) : (specret value))) : ext_expr) ((out_ter (S : state) (v : res)) : out))
  ...
  | red_expr_conditional_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (b : bool (* input *)) (e2 : expr (* input *)) (e3 : expr (* input *)) (y1 : (specret value)) (o : out),
        (* ========================================== *)
        (red_spec S C (spec_expr_get_value (((ifb (b = (true : bool)) then (e2 : expr) else e3) : expr) : expr)) y1) ->
        (red_expr (S : state) (C : execution_ctx) ((expr_conditional_2 (y1 : (specret value))) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_conditional_1 ((vret S b) : (specret value)) (e2 : expr) (e3 : expr)) : ext_expr) (o : out))

  | red_expr_conditional_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_conditional_2 ((ret S v) : (specret value))) : ext_expr) ((out_ter (S : state) (v : res)) : out))
  ...
  | red_expr_assign_2_compound_get_value :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (rv : resvalue (* input *)) (op : binary_op (* input *)) (v1 : value (* input *)) (e2 : expr (* input *)) (y1 : (specret value)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_assign_2 (rv : res) ((ret S v1) : (specret value)) (op : binary_op) (e2 : expr)) : ext_expr) (o : out))
  ...
  | red_expr_assign_3_compound_op :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (rv : resvalue (* input *)) (op : binary_op (* input *)) (v1 : value (* input *)) (v2 : value (* input *)) (o1 : out) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_assign_3 (rv : res) (v1 : value) (op : binary_op) ((ret S v2) : (specret value))) : ext_expr) (o : out))
  ...
  | red_expr_assign_4_put_value :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (rv : resvalue (* input *)) (v : value (* input *)) (o1 : out) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((expr_assign_4 (rv : res) ((ret S v) : (specret value))) : ext_expr) (o : out))
  ...
  | red_spec_prim_new_object_bool :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (b : bool (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_prim_new_object ((prim_bool (b : bool)) : prim)) : ext_expr) ((out_ter ((snd ((object_alloc S ((object_with_primitive_value ((object_new prealloc_bool_proto (("Boolean")%string)) : object) b) : object)) : (object_loc * state))) : state) ((fst ((object_alloc S ((object_with_primitive_value ((object_new prealloc_bool_proto (("Boolean")%string)) : object) b) : object)) : (object_loc * state))) : res)) : out))

  | red_spec_prim_new_object_number :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (n : number (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_prim_new_object ((prim_number (n : number)) : prim)) : ext_expr) ((out_ter ((snd ((object_alloc S ((object_with_primitive_value ((object_new prealloc_number_proto (("Number")%string)) : object) n) : object)) : (object_loc * state))) : state) ((fst ((object_alloc S ((object_with_primitive_value ((object_new prealloc_number_proto (("Number")%string)) : object) n) : object)) : (object_loc * state))) : res)) : out))

  | red_spec_prim_new_object_string :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (s : string (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_prim_new_object ((prim_string (s : string)) : prim)) : ext_expr) ((out_ter ((snd ((object_alloc S ((object_with_primitive_value ((object_with_get_own_property ((object_new prealloc_string_proto (("String")%string)) : object) builtin_get_own_prop_string) : object) s) : object)) : (object_loc * state))) : state) ((fst ((object_alloc S ((object_with_primitive_value ((object_with_get_own_property ((object_new prealloc_string_proto (("String")%string)) : object) builtin_get_own_prop_string) : object) s) : object)) : (object_loc * state))) : res)) : out))
  ...
  | red_spec_to_boolean :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_to_boolean (v : value)) : ext_expr) ((out_ter (S : state) (((convert_value_to_boolean (v : value)) : bool) : res)) : out))

  | red_spec_to_number_prim :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (w : prim (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_to_number ((value_prim (w : prim)) : value)) : ext_expr) ((out_ter (S : state) (((convert_prim_to_number (w : prim)) : number) : res)) : out))
  ...
  | red_spec_to_number_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (w : prim (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_to_number_1 ((out_ter (S : state) (w : res)) : out)) : ext_expr) ((out_ter (S : state) (((convert_prim_to_number (w : prim)) : number) : res)) : out))
  ...
  | red_spec_to_integer_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (n : number (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_to_integer_1 ((out_ter (S : state) (n : res)) : out)) : ext_expr) ((out_ter (S : state) (((convert_number_to_integer (n : number)) : number) : res)) : out))

  | red_spec_to_string_prim :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (w : prim (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_to_string ((value_prim (w : prim)) : value)) : ext_expr) ((out_ter (S : state) (((convert_prim_to_string (w : prim)) : string) : res)) : out))
  ...
  | red_spec_to_string_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (w : prim (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_to_string_1 ((out_ter (S : state) (w : res)) : out)) : ext_expr) ((out_ter (S : state) (((convert_prim_to_string (w : prim)) : string) : res)) : out))
  ...
  | red_spec_object_get_2_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vthis : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_get_2 (vthis : value) ((dret S full_descriptor_undef) : (specret full_descriptor))) : ext_expr) ((out_ter (S : state) (undef : res)) : out))
  ...
  | red_spec_object_get_2_data :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vthis : value (* input *)) (Ad : attributes_data (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_get_2 (vthis : value) ((dret S (attributes_data_of (Ad : attributes_data))) : (specret full_descriptor))) : ext_expr) ((out_ter (S : state) (((attributes_data_value (Ad : attributes_data)) : value) : res)) : out))
  ...
  | red_spec_object_get_2_accessor :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vthis : value (* input *)) (Aa : attributes_accessor (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_get_2 (vthis : value) ((dret S (attributes_accessor_of (Aa : attributes_accessor))) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_can_put_2_accessor :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (Aa : attributes_accessor (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_can_put_2 (l : object_loc) (x : prop_name) ((ret (T := full_descriptor) S0 (attributes_accessor_of (Aa : attributes_accessor))) : (specret full_descriptor))) : ext_expr) ((out_ter (S0 : state) (((ifb ((attributes_accessor_set (Aa : attributes_accessor)) = (undef : value)) then (false : bool) else true) : bool) : res)) : out))
  ...
  | red_spec_object_can_put_2_data :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (Ad : attributes_data (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_can_put_2 (l : object_loc) (x : prop_name) ((ret (T := full_descriptor) S0 (attributes_data_of (Ad : attributes_data))) : (specret full_descriptor))) : ext_expr) ((out_ter (S0 : state) (((attributes_data_writable (Ad : attributes_data)) : bool) : res)) : out))
  ...
  | red_spec_object_can_put_2_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (o : out) (lproto : value),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_can_put_2 (l : object_loc) (x : prop_name) ((ret S full_descriptor_undef) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_can_put_5_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (b : bool),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_can_put_5 (l : object_loc) ((dret S full_descriptor_undef) : (specret full_descriptor))) : ext_expr) ((out_ter (S : state) (b : res)) : out))
  ...
  | red_spec_object_can_put_5_accessor :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (Aa : attributes_accessor (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_can_put_5 (l : object_loc) ((dret S (attributes_accessor_of (Aa : attributes_accessor))) : (specret full_descriptor))) : ext_expr) ((out_ter (S : state) (((ifb ((attributes_accessor_set (Aa : attributes_accessor)) = (undef : value)) then (false : bool) else true) : bool) : res)) : out))
  ...
  | red_spec_object_can_put_5_data :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (Ad : attributes_data (* input *)) (bext : bool) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_can_put_5 (l : object_loc) ((dret S (attributes_data_of (Ad : attributes_data))) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_can_put_6_extens_true :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (Ad : attributes_data (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_can_put_6 (Ad : attributes_data) (true : bool)) : ext_expr) ((out_ter (S : state) (((attributes_data_writable (Ad : attributes_data)) : bool) : res)) : out))
  ...
  | red_spec_object_put_3_data_object :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (lthis : object_loc (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)) (throw : bool (* input *)) (Ad : attributes_data (* input *)) (o1 : out) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) (x : prop_name) (((descriptor_intro ((Some v) : (option value)) (None : (option bool)) (None : (option value)) (None : (option value)) (None : (option bool)) (None : (option bool))) : descriptor) : descriptor) (throw : bool)) : ext_expr) (o1 : out)) ->
        (red_expr (S : state) (C : execution_ctx) ((spec_object_put_5 (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_put_3 (lthis : value) (l : object_loc) (x : prop_name) (v : value) (throw : bool) ((ret (T := full_descriptor) S (attributes_data_of (Ad : attributes_data))) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_put_3_data_prim :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (wthis : prim (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)) (throw : bool (* input *)) (Ad : attributes_data (* input *)) (o : out),
        ...
        (red_expr (S : state) (C : execution_ctx) ((spec_error_or_void (throw : bool) (native_error_type : native_error)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_put_3 (wthis : value) (l : object_loc) (x : prop_name) (v : value) (throw : bool) ((ret (T := full_descriptor) S (attributes_data_of (Ad : attributes_data))) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_put_3_not_data :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vthis : value (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)) (throw : bool (* input *)) (Aa : attributes_accessor) (y1 : (specret full_descriptor)) (o : out) (D : full_descriptor (* input *)),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_put_3 (vthis : value) (l : object_loc) (x : prop_name) (v : value) (throw : bool) ((ret S D) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_put_4_accessor :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vsetter : value) (lfsetter : object_loc) (vthis : value (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)) (throw : bool (* input *)) (Aa : attributes_accessor (* input *)) (o1 : out) (o : out),
        ...
        (red_expr (S : state) (C : execution_ctx) ((spec_object_put_5 (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_put_4 (vthis : value) (l : object_loc) (x : prop_name) (v : value) (throw : bool) ((dret S (attributes_accessor_of (Aa : attributes_accessor))) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_put_4_not_accessor_object :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (D : full_descriptor (* input *)) (lthis : object_loc (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)) (throw : bool (* input *)) (Ad : attributes_data) (o1 : out) (o : out),
        ...
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) (x : prop_name) (((descriptor_intro_data v true true true) : descriptor) : descriptor) (throw : bool)) : ext_expr) (o1 : out)) ->
        (red_expr (S : state) (C : execution_ctx) ((spec_object_put_5 (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_put_4 (lthis : value) (l : object_loc) (x : prop_name) (v : value) (throw : bool) ((dret S D) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_put_4_not_accessor_prim :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (wthis : prim (* input *)) (D : full_descriptor (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)) (throw : bool (* input *)) (Ad : attributes_data) (o : out),
        ...
        (red_expr (S : state) (C : execution_ctx) ((spec_error_or_void (throw : bool) (native_error_type : native_error)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_put_4 (wthis : value) (l : object_loc) (x : prop_name) (v : value) (throw : bool) ((dret S D) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_has_prop_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (D : full_descriptor (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_has_prop_2 ((ret S D) : (specret full_descriptor))) : ext_expr) ((out_ter (S : state) (((ifb (D = (full_descriptor_undef : full_descriptor)) then (false : bool) else true) : bool) : res)) : out))
  ...
  | red_spec_object_delete_2_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (throw : bool (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_delete_2 (l : object_loc) (x : prop_name) (throw : bool) ((ret S full_descriptor_undef) : (specret full_descriptor))) : ext_expr) ((out_ter (S : state) (true : res)) : out))
  ...
  | red_spec_object_delete_2_some_configurable :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (throw : bool (* input *)) (A : attributes (* input *)) (S' : state),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_delete_2 (l : object_loc) (x : prop_name) (throw : bool) ((ret S (full_descriptor_some (A : attributes))) : (specret full_descriptor))) : ext_expr) ((out_ter (S' : state) (true : res)) : out))
  ...
  | red_spec_object_delete_3_some_non_configurable :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (throw : bool (* input *)) (A : attributes (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_delete_2 (l : object_loc) (x : prop_name) (throw : bool) ((ret S (full_descriptor_some (A : attributes))) : (specret full_descriptor))) : ext_expr) (o : out))

  | red_spec_object_default_value_1_default :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (prefo : (option preftype) (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_default_value_2 (l : object_loc) (((unsome_default preftype_number prefo) : preftype) : preftype) ((other_preftypes ((unsome_default preftype_number prefo) : preftype)) : preftype)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_object_default_value_sub_2_callable :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (lfunc : object_loc) (l : object_loc (* input *)) (K : ext_expr (* input *)) (o : out) (B : _) (o1 : out),
        (callable S ((value_object (lfunc : object_loc)) : value) (Some B)) ->
        (* ========================================== *)
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_default_value_sub_2 (l : object_loc) ((out_ter (S : state) (((value_object (lfunc : object_loc)) : value) : res)) : out) (K : ext_expr)) : ext_expr) (o : out))
  ...
  | red_spec_object_define_own_prop_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (Desc : descriptor (* input *)) (throw : bool (* input *)) (An : full_descriptor (* input *)) (bext : bool) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_object_define_own_prop_2 (l : object_loc) (x : prop_name) (Desc : descriptor) (throw : bool) ((ret S An) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_define_own_prop_3_undef_true :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (Desc : descriptor (* input *)) (throw : bool (* input *)) (S' : state),
        (object_set_property S l x ((ifb (((descriptor_is_generic Desc) : Prop) \/ ((descriptor_is_data Desc) : Prop)) then ((attributes_data_of_descriptor (Desc : descriptor)) : attributes) else ((attributes_accessor_of_descriptor (Desc : descriptor)) : attributes)) : attributes) S') ->
        (* ========================================== *)
        (* ------------------------------------------ *)
  ...
  | red_spec_object_define_own_prop_6a_accept :
      forall (S : state (* input *)) (S' : state) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (A : attributes (* input *)) (Desc : descriptor (* input *)) (throw : bool (* input *)) (o : out),
        ((attributes_configurable (A : attributes)) = (true : bool)) ->
        (object_set_property S l x match A return attributes with (attributes_data_of Ad) => (attributes_accessor_of_attributes_data (Ad : attributes_data)) | (attributes_accessor_of Aa) => (attributes_data_of_attributes_accessor (Aa : attributes_accessor)) end S') ->
        (* ========================================== *)
        (red_expr (S' : state) (C : execution_ctx) ((spec_object_define_own_prop_write (l : object_loc) (x : prop_name) (match A return attributes with (attributes_data_of Ad) => (attributes_accessor_of_attributes_data (Ad : attributes_data)) | (attributes_accessor_of Aa) => (attributes_data_of_attributes_accessor (Aa : attributes_accessor)) end : attributes) (Desc : descriptor) (throw : bool)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop_6a (l : object_loc) (x : prop_name) (A : attributes) (Desc : descriptor) (throw : bool)) : ext_expr) (o : out))
  ...
  | red_spec_object_define_own_prop_write :
      forall (S : state (* input *)) (S' : state) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (A : attributes (* input *)) (Desc : descriptor (* input *)) (throw : bool (* input *)),
        (object_set_property S l x ((attributes_update (A : attributes) (Desc : descriptor)) : attributes) S') ->
        (* ========================================== *)
        (* ------------------------------------------ *)
  ...
  | red_spec_env_record_has_binding_1_decl :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (L : env_loc (* input *)) (x : prop_name (* input *)) (Ed : decl_env_record (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_env_record_has_binding_1 (L : env_loc) (x : prop_name) ((env_record_decl (Ed : decl_env_record)) : env_record)) : ext_expr) ((out_ter (S : state) (((ifb (decl_env_record_indom (Ed : decl_env_record) (x : string)) then (true : bool) else false) : bool) : res)) : out))
  ...
  | red_spec_env_record_create_mutable_binding :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (L : env_loc (* input *)) (x : prop_name (* input *)) (deletable_opt : (option bool) (* input *)) (o : out) (E : env_record),
        (env_record_binds (S : state) (L : env_loc) (E : env_record)) ->
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_env_record_create_mutable_binding_1 (L : env_loc) (x : prop_name) ((unsome_default false deletable_opt) : bool) (E : env_record)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_env_record_create_mutable_binding_1_decl_indom :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (L : env_loc (* input *)) (x : prop_name (* input *)) (deletable : bool (* input *)) (Ed : decl_env_record (* input *)),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_env_record_create_mutable_binding_1 (L : env_loc) (x : prop_name) (deletable : bool) ((env_record_decl (Ed : decl_env_record)) : env_record)) : ext_expr) ((out_void (((env_record_write_decl_env S L x (mutability_of_bool (deletable : bool)) undef) : state) : state)) : out))
  ...
  | red_spec_env_record_create_mutable_binding_obj_2 :
      forall (S0 : state (* input *)) (C : execution_ctx (* input *)) (L : env_loc (* input *)) (x : prop_name (* input *)) (deletable : bool (* input *)) (l : object_loc (* input *)) (S : state (* input *)) (o1 : out) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) (x : prop_name) (((attributes_data_intro (undef : value) (true : bool) (true : bool) (deletable : bool)) : attributes) : descriptor) (throw_true : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_env_record_implicit_this_value_1_object :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (L : env_loc (* input *)) (l : object_loc (* input *)) (pt : bool (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_env_record_implicit_this_value_1 (L : env_loc) ((env_record_object (l : object_loc) (pt : provide_this_flag)) : env_record)) : ext_expr) ((out_ter (S : state) (((ifb pt then (l : value) else undef) : value) : res)) : out))
  ...
  | red_spec_env_record_create_immutable_binding :
      forall (Ed : decl_env_record) (S : state (* input *)) (C : execution_ctx (* input *)) (L : env_loc (* input *)) (x : prop_name (* input *)),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_env_record_create_immutable_binding (L : env_loc) (x : prop_name)) : ext_expr) ((out_void (((env_record_write_decl_env S L x mutability_uninitialized_immutable undef) : state) : state)) : out))
  ...
  | red_spec_env_record_initialize_immutable_binding :
      forall (Ed : decl_env_record) (v_old : value) (S : state (* input *)) (C : execution_ctx (* input *)) (L : env_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_env_record_initialize_immutable_binding (L : env_loc) (x : prop_name) (v : value)) : ext_expr) ((out_void (((env_record_write_decl_env S L x mutability_immutable v) : state) : state)) : out))
  ...
  | red_spec_env_record_create_set_mutable_binding_1 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (L : env_loc (* input *)) (x : prop_name (* input *)) (v : value (* input *)) (str : strictness_flag (* input *)) (o : out),
        ...
        (red_expr (S : state) (C : execution_ctx) ((spec_env_record_set_mutable_binding (L : env_loc) (x : prop_name) (v : value) (str : bool)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_env_record_create_set_mutable_binding_1 ((out_void (S : state)) : out) (L : env_loc) (x : prop_name) (v : value) (str : bool)) : ext_expr) (o : out))
  ...
  | red_spec_entering_eval_code :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (bdirect : bool (* input *)) (bd : funcbody (* input *)) (K : ext_expr (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (((ifb bdirect then (C : execution_ctx) else (execution_ctx_initial (((((funcbody_is_strict bd) : bool) || ((bdirect && (execution_ctx_strict C)) : bool)) : strictness_flag) : strictness_flag))) : execution_ctx) : execution_ctx) ((spec_entering_eval_code_1 (bd : funcbody) (K : ext_expr) (((((funcbody_is_strict bd) : bool) || ((bdirect && (execution_ctx_strict C)) : bool)) : strictness_flag) : bool)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_entering_eval_code_1 :
      forall (str : bool (* input *)) (lex : lexical_env) (S' : state) (o1 : out) (S : state (* input *)) (C : execution_ctx (* input *)) (bd : funcbody (* input *)) (K : ext_expr (* input *)) (o : out),
        ...
        (* ========================================== *)
        (red_expr (S' : state) (((ifb str then ((execution_ctx_with_lex_same (C : execution_ctx) (lex : lexical_env)) : execution_ctx) else C) : execution_ctx) : execution_ctx) ((spec_binding_inst (codetype_eval : codetype) (None : (option object_loc)) ((funcbody_prog bd) : prog) (nil : (list value))) : ext_expr) (o1 : out)) ->
        (red_expr (S' : state) (((ifb str then ((execution_ctx_with_lex_same (C : execution_ctx) (lex : lexical_env)) : execution_ctx) else C) : execution_ctx) : execution_ctx) ((spec_entering_eval_code_2 (o1 : out) (K : ext_expr)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_entering_eval_code_2 :
      forall (S0 : state (* input *)) (C : execution_ctx (* input *)) (S : state (* input *)) (K : ext_expr (* input *)) (o : out),
        ...
        (red_expr (S : state) (C : execution_ctx) (K : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_entering_eval_code_2 ((out_void (S : state)) : out) (K : ext_expr)) : ext_expr) (o : out))
  ...
  | red_spec_entering_func_code :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (lf : object_loc (* input *)) (vthis : value (* input *)) (args : (list value) (* input *)) (bd : funcbody) (K : ext_expr (* input *)) (o : out),
        ...
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_entering_func_code_1 (lf : object_loc) (args : (list value)) (bd : funcbody) (vthis : value) (((funcbody_is_strict bd) : strictness_flag) : strictness_flag) (K : ext_expr)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_entering_func_code_1_strict :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (lf : object_loc (* input *)) (args : (list value) (* input *)) (bd : funcbody (* input *)) (vthis : value (* input *)) (K : ext_expr (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_entering_func_code_1 (lf : object_loc) (args : (list value)) (bd : funcbody) (vthis : value) (strictness_true : strictness_flag) (K : ext_expr)) : ext_expr) (o : out))
  ...
  | red_spec_entering_func_code_1_null_or_undef :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (lf : object_loc (* input *)) (args : (list value) (* input *)) (bd : funcbody (* input *)) (vthis : value (* input *)) (K : ext_expr (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_entering_func_code_1 (lf : object_loc) (args : (list value)) (bd : funcbody) (vthis : value) (strictness_false : strictness_flag) (K : ext_expr)) : ext_expr) (o : out))
  ...
  | red_spec_entering_func_code_1_object :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (lf : object_loc (* input *)) (args : (list value) (* input *)) (bd : funcbody (* input *)) (lthis : object_loc (* input *)) (K : ext_expr (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_entering_func_code_1 (lf : object_loc) (args : (list value)) (bd : funcbody) (lthis : value) (strictness_false : strictness_flag) (K : ext_expr)) : ext_expr) (o : out))
  ...
  | red_spec_entering_func_code_3 :
      forall (o1 : out) (S : state (* input *)) (C : execution_ctx (* input *)) (lf : object_loc (* input *)) (args : (list value) (* input *)) (str : strictness_flag (* input *)) (bd : funcbody (* input *)) (vthis : value (* input *)) (lex : _) (K : ext_expr (* input *)) (o : out),
        ...
        (* ========================================== *)
        (red_expr ((snd (lexical_env_alloc_decl S lex)) : state) (((execution_ctx_intro_same ((fst (lexical_env_alloc_decl S lex)) : lexical_env) (vthis : value) (str : strictness_flag)) : execution_ctx) : execution_ctx) ((spec_binding_inst (codetype_func : codetype) ((Some lf) : (option object_loc)) ((funcbody_prog bd) : prog) (args : (list value))) : ext_expr) (o1 : out)) ->
        (red_expr ((snd (lexical_env_alloc_decl S lex)) : state) (((execution_ctx_intro_same ((fst (lexical_env_alloc_decl S lex)) : lexical_env) (vthis : value) (str : strictness_flag)) : execution_ctx) : execution_ctx) ((spec_entering_func_code_4 (o1 : out) (K : ext_expr)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_entering_func_code_4 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (K : ext_expr (* input *)) (o : out),
        ...
        (red_expr (S : state) (C : execution_ctx) (K : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_entering_func_code_4 ((out_void (S : state)) : out) (K : ext_expr)) : ext_expr) (o : out))
  ...
  | red_spec_binding_inst_formal_params_non_empty :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (args : (list value) (* input *)) (L : env_loc (* input *)) (x : prop_name (* input *)) (xs : (list prop_name) (* input *)) (str : strictness_flag (* input *)) (o1 : out) (o : out),
        ...
        (red_expr (S : state) (C : execution_ctx) ((spec_binding_inst_formal_params_1 ((snd match args with nil => (undef, nil) | (v :: args') => (v, args') end) : (list value)) (L : env_loc) (x : string) (xs : (list string)) (str : strictness_flag) ((fst match args with nil => (undef, nil) | (v :: args') => (v, args') end) : value) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_binding_inst_formal_params_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (args : (list value) (* input *)) (L : env_loc (* input *)) (x : prop_name (* input *)) (xs : (list prop_name) (* input *)) (str : strictness_flag (* input *)) (v : value (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_binding_inst_formal_params_2 (args : (list value)) (L : env_loc) (x : string) (xs : (list string)) (str : strictness_flag) (v : value) ((out_void (S : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_binding_inst_formal_params_4 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (args : (list value) (* input *)) (L : env_loc (* input *)) (xs : (list prop_name) (* input *)) (str : strictness_flag (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_binding_inst_formal_params_4 (args : (list value)) (L : env_loc) (xs : (list string)) (str : strictness_flag) ((out_void (S : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_binding_inst_function_decls_cons :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (L : env_loc (* input *)) (args : (list value) (* input *)) (fd : funcdecl (* input *)) (fds : (list funcdecl) (* input *)) (str : strictness_flag (* input *)) (bconfig : bool (* input *)) (o1 : out) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_creating_function_object ((funcdecl_parameters (fd : funcdecl)) : (list string)) ((funcdecl_body (fd : funcdecl)) : funcbody) ((execution_ctx_variable_env (C : execution_ctx)) : lexical_env) ((funcbody_is_strict (funcdecl_body (fd : funcdecl))) : strictness_flag)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_binding_inst_function_decls_3_true :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (args : (list value) (* input *)) (fd : funcdecl (* input *)) (fds : (list funcdecl) (* input *)) (str : strictness_flag (* input *)) (fo : object_loc (* input *)) (bconfig : bool (* input *)) (A : attributes (* input *)) (Anew : attributes_data) (o1 : out) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_binding_inst_function_decls_3 (args : (list value)) (fd : funcdecl) (fds : (list funcdecl)) (str : strictness_flag) (fo : object_loc) (bconfig : bool) ((ret S (full_descriptor_some (A : attributes))) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_binding_inst_function_decls_6 :
      forall (L : env_loc (* input *)) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (args : (list value) (* input *)) (fds : (list funcdecl) (* input *)) (str : strictness_flag (* input *)) (bconfig : bool (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_binding_inst_function_decls_6 (args : (list value)) (L : env_loc) (fds : (list funcdecl)) (str : strictness_flag) (bconfig : bool) ((out_void (S : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_binding_inst_arg_obj :
      forall (o1 : out) (L : env_loc (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (lf : object_loc (* input *)) (code : prog (* input *)) (xs : (list prop_name) (* input *)) (args : (list value) (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_create_arguments_object (lf : object_loc) (xs : (list string)) (args : (list value)) ((execution_ctx_variable_env (C : execution_ctx)) : lexical_env) (((prog_intro_strictness code) : strictness_flag) : strictness_flag)) : ext_expr) (o1 : out)) ->
        (red_expr (S : state) (C : execution_ctx) ((spec_binding_inst_arg_obj_1 (code : prog) (L : env_loc) (((prog_intro_strictness code) : strictness_flag) : strictness_flag) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_binding_inst_arg_obj_2 :
      forall (L : env_loc (* input *)) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (code : prog (* input *)) (largs : object_loc (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_binding_inst_arg_obj_2 (code : prog) (L : env_loc) (largs : object_loc) ((out_void (S : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_binding_inst_var_decls_2 :
      forall (L : env_loc (* input *)) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vds : (list string) (* input *)) (bconfig : bool (* input *)) (str : strictness_flag (* input *)) (o : out),
        ...
        (red_expr (S : state) (C : execution_ctx) ((spec_binding_inst_var_decls (L : env_loc) (vds : (list string)) (bconfig : bool) (str : strictness_flag)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_binding_inst_var_decls_2 (L : env_loc) (vds : (list string)) (bconfig : bool) (str : strictness_flag) ((out_void (S : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_binding_inst_2 :
      forall (S0 : state (* input *)) (xs : (list prop_name) (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (lf : object_loc (* input *)) (code : prog (* input *)) (args : (list value) (* input *)) (L : env_loc (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_binding_inst_2 (codetype_func : codetype) (lf : object_loc) (code : prog) (xs : (list string)) (args : (list value)) (L : env_loc) ((out_void (S : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_binding_inst_4 :
      forall (bconfig : bool (* input *)) (L : env_loc (* input *)) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (ct : codetype (* input *)) (olf : (option object_loc) (* input *)) (code : prog (* input *)) (xs : (list prop_name) (* input *)) (args : (list value) (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_binding_inst_4 (ct : codetype) (olf : (option object_loc)) (code : prog) (xs : (list string)) (args : (list value)) (bconfig : bool) (L : env_loc) ((out_void (S : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_binding_inst_7 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (code : prog (* input *)) (bconfig : bool (* input *)) (L : env_loc (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_binding_inst_7 (code : prog) (bconfig : bool) (L : env_loc) ((out_void (S : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_object_get_args_obj_1_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vthis : value (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (lmap : object_loc (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_args_obj_get_1 (vthis : value) (l : object_loc) (x : prop_name) (lmap : object_loc) ((ret S0 full_descriptor_undef) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_get_args_obj_1_attrs :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vthis : value (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (lmap : object_loc (* input *)) (A : attributes (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_args_obj_get_1 (vthis : value) (l : object_loc) (x : prop_name) (lmap : object_loc) ((ret S0 (full_descriptor_some (A : attributes))) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_define_own_prop_args_obj_1 :
      forall (o1 : out) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (Desc : descriptor (* input *)) (throw : bool (* input *)) (lmap : object_loc (* input *)) (Dmap : full_descriptor (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_args_obj_define_own_prop_1 (l : object_loc) (x : prop_name) (Desc : descriptor) (throw : bool) (lmap : object_loc) ((ret S0 Dmap) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_object_define_own_prop_args_obj_3 :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (Desc : descriptor (* input *)) (throw : bool (* input *)) (lmap : object_loc (* input *)) (S' : state (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_args_obj_define_own_prop_3 (l : object_loc) (x : prop_name) (Desc : descriptor) (throw : bool) (lmap : object_loc) ((out_void (S' : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_object_delete_args_obj_1 :
      forall (o1 : out) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (throw : bool (* input *)) (lmap : object_loc (* input *)) (D : full_descriptor (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_args_obj_delete_1 (l : object_loc) (x : prop_name) (throw : bool) (lmap : object_loc) ((ret S0 D) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_arguments_object_map_2_positive :
      forall (o1 : out) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (xs : (list prop_name) (* input *)) (args : (list value) (* input *)) (X : lexical_env (* input *)) (str : strictness_flag (* input *)) (lmap : object_loc (* input *)) (xsmap : (list string) (* input *)) (k : int (* input *)) (v : value) (o : out),
        (ZNth k args v) ->
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((convert_prim_to_string (k : prim)) : prop_name) (((attributes_data_intro_all_true (v : value)) : attributes) : descriptor) (false : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_arguments_object_map_6 :
      forall (o1 : out) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (xs : (list prop_name) (* input *)) (args : (list value) (* input *)) (X : lexical_env (* input *)) (str : strictness_flag (* input *)) (lmap : object_loc (* input *)) (xsmap : (list string) (* input *)) (k : int (* input *)) (lgetter : object_loc (* input *)) (S' : state (* input *)) (lsetter : object_loc (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S' : state) (C : execution_ctx) ((spec_object_define_own_prop (lmap : object_loc) ((convert_prim_to_string (k : prim)) : prop_name) (((attributes_accessor_intro ((value_object (lgetter : object_loc)) : value) ((value_object (lsetter : object_loc)) : value) (false : bool) (true : bool)) : attributes) : descriptor) (false : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_arguments_object_map_8_cons :
      forall (O : object) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (lmap : object_loc (* input *)) (xsmap : (list string) (* input *)),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_arguments_object_map_8 (l : object_loc) (lmap : object_loc) (xsmap : (list string))) : ext_expr) ((out_void (((object_write S l ((object_for_args_object O lmap builtin_get_args_obj builtin_get_own_prop_args_obj builtin_define_own_prop_args_obj builtin_delete_args_obj) : object)) : state) : state)) : out))
  ...
  | red_spec_create_arguments_object :
      forall (o1 : out) (S : state (* input *)) (C : execution_ctx (* input *)) (lf : object_loc (* input *)) (xs : (list prop_name) (* input *)) (args : (list value) (* input *)) (X : lexical_env (* input *)) (str : strictness_flag (* input *)) (o : out),
        (* ========================================== *)
        (red_expr ((snd ((object_alloc S ((object_new prealloc_object_proto (("Arguments")%string)) : object)) : (object_loc * state))) : state) (C : execution_ctx) ((spec_object_define_own_prop ((fst ((object_alloc S ((object_new prealloc_object_proto (("Arguments")%string)) : object)) : (object_loc * state))) : object_loc) ((("length")%string) : prop_name) (((attributes_data_intro ((JsNumber.of_int (length args)) : value) (true : bool) (false : bool) (true : bool)) : attributes) : descriptor) (false : bool)) : ext_expr) (o1 : out)) ->
        (red_expr ((snd ((object_alloc S ((object_new prealloc_object_proto (("Arguments")%string)) : object)) : (object_loc * state))) : state) (C : execution_ctx) ((spec_create_arguments_object_1 (lf : object_loc) (xs : (list string)) (args : (list value)) (X : lexical_env) (str : strictness_flag) ((fst ((object_alloc S ((object_new prealloc_object_proto (("Arguments")%string)) : object)) : (object_loc * state))) : object_loc) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_create_arguments_object_2_non_strict :
      forall (o1 : out) (S : state (* input *)) (C : execution_ctx (* input *)) (lf : object_loc (* input *)) (l : object_loc (* input *)) (S' : state (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S' : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((("callee")%string) : prop_name) (((attributes_data_intro ((value_object (lf : object_loc)) : value) (true : bool) (false : bool) (true : bool)) : attributes) : descriptor) (false : bool)) : ext_expr) (o1 : out)) ->
        (red_expr (S' : state) (C : execution_ctx) ((spec_create_arguments_object_4 (l : object_loc) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_create_arguments_object_2 (lf : object_loc) (false : strictness_flag) (l : object_loc) ((out_void (S' : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_create_arguments_object_2_strict :
      forall (vthrower : value) (o1 : out) (S : state (* input *)) (C : execution_ctx (* input *)) (lf : object_loc (* input *)) (l : object_loc (* input *)) (S' : state (* input *)) (o : out),
        ...
        (* ========================================== *)
        (red_expr (S' : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((("caller")%string) : prop_name) (((attributes_accessor_intro (vthrower : value) (vthrower : value) (false : bool) (false : bool)) : attributes) : descriptor) (false : bool)) : ext_expr) (o1 : out)) ->
        (red_expr (S' : state) (C : execution_ctx) ((spec_create_arguments_object_3 (l : object_loc) (vthrower : value) (((attributes_accessor_intro (vthrower : value) (vthrower : value) (false : bool) (false : bool)) : attributes) : attributes) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_create_arguments_object_2 (lf : object_loc) (true : strictness_flag) (l : object_loc) ((out_void (S' : state)) : out)) : ext_expr) (o : out))
  ...
  | red_spec_creating_function_object_proto_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (lproto : object_loc (* input *)) (o1 : out) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (lproto : object_loc) ((("constructor")%string) : prop_name) (((attributes_data_intro ((value_object (l : object_loc)) : value) (true : bool) (false : bool) (true : bool)) : attributes_data) : descriptor) (false : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_creating_function_object_proto_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (lproto : object_loc (* input *)) (b : bool (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((("prototype")%string) : prop_name) (((attributes_data_intro ((value_object (lproto : object_loc)) : value) (true : bool) (false : bool) (false : bool)) : attributes_data) : descriptor) (false : bool)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_creating_function_object :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (names : (list string) (* input *)) (bd : funcbody (* input *)) (X : lexical_env (* input *)) (str : strictness_flag (* input *)) (o1 : out) (o : out),
        (* ========================================== *)
        (red_expr ((snd ((object_alloc S ((object_with_details ((object_with_invokation ((object_with_get ((object_new prealloc_function_proto (("Function")%string)) : object) builtin_get_function) : object) (Some construct_default) (Some call_default) (Some builtin_has_instance_function)) : object) (Some X) (Some names) (Some bd) None None None None) : object)) : (object_loc * state))) : state) (C : execution_ctx) ((spec_object_define_own_prop ((fst ((object_alloc S ((object_with_details ((object_with_invokation ((object_with_get ((object_new prealloc_function_proto (("Function")%string)) : object) builtin_get_function) : object) (Some construct_default) (Some call_default) (Some builtin_has_instance_function)) : object) (Some X) (Some names) (Some bd) None None None None) : object)) : (object_loc * state))) : object_loc) ((("length")%string) : prop_name) (((attributes_data_intro ((JsNumber.of_int (length names)) : value) (false : bool) (false : bool) (false : bool)) : attributes) : descriptor) (false : bool)) : ext_expr) (o1 : out)) ->
        (red_expr ((snd ((object_alloc S ((object_with_details ((object_with_invokation ((object_with_get ((object_new prealloc_function_proto (("Function")%string)) : object) builtin_get_function) : object) (Some construct_default) (Some call_default) (Some builtin_has_instance_function)) : object) (Some X) (Some names) (Some bd) None None None None) : object)) : (object_loc * state))) : state) (C : execution_ctx) ((spec_creating_function_object_1 (str : strictness_flag) ((fst ((object_alloc S ((object_with_details ((object_with_invokation ((object_with_get ((object_new prealloc_function_proto (("Function")%string)) : object) builtin_get_function) : object) (Some construct_default) (Some call_default) (Some builtin_has_instance_function)) : object) (Some X) (Some names) (Some bd) None None None None) : object)) : (object_loc * state))) : object_loc) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_creating_function_object_3 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vthrower : value) (l : object_loc (* input *)) (b : bool (* input *)) (o1 : out) (o : out),
        ((vthrower : value) = (value_object (prealloc_throw_type_error : object_loc))) ->
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((("arguments")%string) : prop_name) (((attributes_accessor_intro (vthrower : value) (vthrower : value) (false : bool) (false : bool)) : attributes) : descriptor) (false : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_call_default_3_return :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (rv : resvalue (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_default_3 ((out_ter (S : state) ((res_return (rv : resvalue)) : res)) : out)) : ext_expr) ((out_ter (S : state) (rv : res)) : out))

  | red_spec_call_default_3_normal :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (rv : resvalue (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_default_3 ((out_ter (S : state) ((res_normal (rv : resvalue)) : res)) : out)) : ext_expr) ((out_ter (S : state) (undef : res)) : out))
  ...
  | red_spec_construct_default_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (vproto : value) (l : object_loc (* input *)) (args : (list value) (* input *)) (v : value (* input *)) (o1 : out) (o : out),
        ...
        (* ========================================== *)
        (red_expr ((snd ((object_alloc S ((object_new vproto (("Object")%string)) : object)) : (object_loc * state))) : state) (C : execution_ctx) ((spec_call (l : object_loc) ((value_object ((fst ((object_alloc S ((object_new vproto (("Object")%string)) : object)) : (object_loc * state))) : object_loc)) : value) (args : (list value))) : ext_expr) (o1 : out)) ->
        (red_expr ((snd ((object_alloc S ((object_new vproto (("Object")%string)) : object)) : (object_loc * state))) : state) (C : execution_ctx) ((spec_construct_default_2 ((fst ((object_alloc S ((object_new vproto (("Object")%string)) : object)) : (object_loc * state))) : object_loc) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_function_construct_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l' : object_loc (* input *)) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_construct_default_2 (l' : object_loc) ((out_ter (S : state) (v : res)) : out)) : ext_expr) ((out_ter (S : state) (((ifb (((type_of v) : type) = type_object) then v else (l' : value)) : value) : res)) : out))
  ...
  | red_spec_from_descriptor_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_from_descriptor ((ret S full_descriptor_undef) : (specret full_descriptor))) : ext_expr) ((out_ter (S : state) (undef : res)) : out))
  ...
  | red_spec_from_descriptor_some :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (o : out) (o1 : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_from_descriptor ((ret S (full_descriptor_some (A : attributes))) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_from_descriptor_1_data :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (Ad : attributes_data (* input *)) (l : object_loc (* input *)) (o : out) (o1 : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((("value")%string) : prop_name) ((descriptor_of_attributes ((attributes_data_intro_all_true ((attributes_data_value (Ad : attributes_data)) : value)) : attributes)) : descriptor) (throw_false : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_from_descriptor_2_data :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (Ad : attributes_data (* input *)) (l : object_loc (* input *)) (b : bool (* input *)) (o : out) (o1 : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((("writable")%string) : prop_name) ((descriptor_of_attributes ((attributes_data_intro_all_true ((attributes_data_writable (Ad : attributes_data)) : value)) : attributes)) : descriptor) (throw_false : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_from_descriptor_1_accessor :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (Aa : attributes_accessor (* input *)) (l : object_loc (* input *)) (o : out) (o1 : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((("get")%string) : prop_name) ((descriptor_of_attributes ((attributes_data_intro_all_true ((attributes_accessor_get (Aa : attributes_accessor)) : value)) : attributes)) : descriptor) (throw_false : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_from_descriptor_3_accessor :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (Aa : attributes_accessor (* input *)) (l : object_loc (* input *)) (b : bool (* input *)) (o : out) (o1 : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((("set")%string) : prop_name) ((descriptor_of_attributes ((attributes_data_intro_all_true ((attributes_accessor_set (Aa : attributes_accessor)) : value)) : attributes)) : descriptor) (throw_false : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_from_descriptor_4 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (l : object_loc (* input *)) (b : bool (* input *)) (o : out) (o1 : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((("enumerable")%string) : prop_name) ((descriptor_of_attributes ((attributes_data_intro_all_true ((attributes_enumerable (A : attributes)) : value)) : attributes)) : descriptor) (throw_false : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_from_descriptor_5 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (l : object_loc (* input *)) (b : bool (* input *)) (o : out) (o1 : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) ((("configurable")%string) : prop_name) ((descriptor_of_attributes ((attributes_data_intro_all_true ((attributes_configurable (A : attributes)) : value)) : attributes)) : descriptor) (throw_false : bool)) : ext_expr) (o1 : out)) ->
  ...
  | red_spec_call_global_eval_1_string_not_parse :
      forall (s : string (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (bdirect : bool (* input *)) (o : out),
        (parse (s : string) (None : (option prog))) ->
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_error (native_error_syntax : native_error)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_call_global_eval_1_string_parse :
      forall (s : string (* input *)) (p : prog) (S : state (* input *)) (C : execution_ctx (* input *)) (bdirect : bool (* input *)) (o : out),
        (parse (s : string) ((Some p) : (option prog))) ->
        (* ========================================== *)
  ...
  | red_spec_call_global_is_nan_1 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (n : number (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_global_is_nan_1 ((out_ter (S : state) (n : res)) : out)) : ext_expr) ((out_ter (S : state) (((ifb (n = (JsNumber.nan : number)) then (true : bool) else false) : bool) : res)) : out))
  ...
  | red_spec_call_global_is_finite_1 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (n : number (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_global_is_finite_1 ((out_ter (S : state) (n : res)) : out)) : ext_expr) ((out_ter (S : state) (((ifb ((((n = JsNumber.nan) \/ (n = JsNumber.infinity)) : Prop) \/ ((n = JsNumber.neg_infinity) : Prop)) then (false : bool) else true) : bool) : res)) : out))
  ...
  | red_spec_call_object_new_1_prim :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)) (o : out),
        ((((((type_of v) : type) = type_string) \/ (((type_of v) : type) = type_bool)) : Prop) \/ ((((type_of v) : type) = type_number) : Prop)) ->
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_to_object (v : value)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_new_1 (v : value)) : ext_expr) (o : out))
  ...
  | red_spec_call_object_new_1_null_or_undef :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_new_1 (v : value)) : ext_expr) ((out_ter ((snd ((object_alloc S ((object_new prealloc_object_proto (("Object")%string)) : object)) : (object_loc * state))) : state) ((fst ((object_alloc S ((object_new prealloc_object_proto (("Object")%string)) : object)) : (object_loc * state))) : res)) : out))
  ...
  | red_spec_call_object_object_create_2 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (O : object) (vo : value (* input *)) (vp : value (* input *)) (o : out),
        (object_binds (S : state) (l : object_loc) (O : object)) ->
        (* ========================================== *)
        (red_expr (((object_write S l ((object_set_proto O vo) : object)) : state) : state) (C : execution_ctx) ((spec_call_object_create_3 (l : object_loc) (vp : value)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_call_object_object_define_prop_2 :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (va : value (* input *)) (o : out) (y : (specret descriptor)),
        ...
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_define_prop_2 (l : object_loc) ((out_ter (S : state) (x : res)) : out) (va : value)) : ext_expr) (o : out))
  ...
  | red_spec_call_object_object_define_prop_3 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (s : string (* input *)) (Desc : descriptor (* input *)) (o1 : out) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_object_define_prop_3 (l : object_loc) (s : string) ((ret S Desc) : (specret descriptor))) : ext_expr) (o : out))

  | red_spec_call_object_object_define_prop_4 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_object_define_prop_4 (l : object_loc) ((out_void (S : state)) : out)) : ext_expr) ((out_ter (S : state) (l : res)) : out))
  ...
  | red_spec_call_object_define_props_5 :
      forall (S : state (* input *)) (S0 : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (l : object_loc (* input *)) (lp : object_loc (* input *)) (o : out) (x : prop_name (* input *)) (xs : (list prop_name) (* input *)) (xAs : (list (prop_name * attributes)) (* input *)),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_object_define_props_5 (l : object_loc) (lp : object_loc) (x : prop_name) (xs : (list prop_name)) (xAs : (list (prop_name * attributes))) ((ret S A) : (specret attributes))) : ext_expr) (o : out))
  ...
  | red_spec_call_object_seal_3 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (xs : (list prop_name) (* input *)) (x : prop_name (* input *)) (A : attributes (* input *)) (o1 : out) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_object_define_own_prop (l : object_loc) (x : prop_name) ((descriptor_of_attributes ((ifb (attributes_configurable (A : attributes)) then ((attributes_with_configurable A false) : attributes) else A) : attributes)) : descriptor) (throw_true : bool)) : ext_expr) (o1 : out)) ->
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_seal_4 (l : object_loc) (xs : (list prop_name)) (o1 : out)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_seal_3 (l : object_loc) (x : prop_name) (xs : (list prop_name)) ((ret (T := full_descriptor) S0 A) : (specret full_descriptor))) : ext_expr) ((out_ter (S : state) (false : res)) : out))
  ...
  | red_spec_call_object_freeze_3 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (xs : (list prop_name) (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_freeze_4 (l : object_loc) (x : prop_name) (xs : (list prop_name)) (match A return attributes with (attributes_data_of Ad) => (attributes_data_of ((ifb (attributes_data_writable (Ad : attributes_data)) then ((attributes_data_with_writable Ad false) : attributes_data) else Ad) : attributes_data)) | (attributes_accessor_of Aa) => (attributes_accessor_of (Aa : attributes_accessor)) end : full_descriptor)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_freeze_3 (l : object_loc) (x : prop_name) (xs : (list prop_name)) ((ret (T := full_descriptor) S0 A) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_call_object_prevent_extensions_object :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (O : object) (l : object_loc (* input *)),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_prevent_extensions_1 (l : value)) : ext_expr) ((out_ter (((object_write S l ((object_with_extension O false) : object)) : state) : state) (l : res)) : out))
  ...
  | red_spec_call_object_is_sealed_3_prop_configurable :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (xs : (list prop_name) (* input *)) (l : object_loc (* input *)),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_is_sealed_3 (l : object_loc) (xs : (list prop_name)) ((ret (T := full_descriptor) S0 A) : (specret full_descriptor))) : ext_expr) ((out_ter (S : state) (false : res)) : out))
  ...
  | red_spec_call_object_is_sealed_3_prop_not_configurable :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (xs : (list prop_name) (* input *)) (l : object_loc (* input *)) (o : out),
        ...
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_is_sealed_2 (l : object_loc) (xs : (list prop_name))) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_is_sealed_3 (l : object_loc) (xs : (list prop_name)) ((ret (T := full_descriptor) S0 A) : (specret full_descriptor))) : ext_expr) (o : out))
  ...
  | red_spec_call_object_is_frozen_3_desc_is_data :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (xs : (list prop_name) (* input *)) (l : object_loc (* input *)) (o : out),
        ((attributes_is_data (A : attributes)) = (true : Prop)) ->
        (* ========================================== *)
        ...
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_is_frozen_3 (l : object_loc) (xs : (list prop_name)) ((ret (T := full_descriptor) S0 A) : (specret full_descriptor))) : ext_expr) (o : out))

  | red_spec_call_object_is_frozen_3_desc_is_not_data :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)) (xs : (list prop_name) (* input *)) (l : object_loc (* input *)) (o : out),
        ((attributes_is_data (A : attributes)) = (false : Prop)) ->
        (* ========================================== *)
  ...
  | red_spec_call_object_proto_to_string_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (sclass : string),
        ...
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_object_proto_to_string_2 ((out_ter (S : state) (l : res)) : out)) : ext_expr) ((out_ter (S : state) ((((("[object ")%string) ++ (((sclass : string) ++ (("]")%string)) : string)) : string) : res)) : out))
  ...
  | red_spec_call_object_proto_has_own_prop_3_undef :
      forall (S : state (* input *)) (S' : state (* input *)) (C : execution_ctx (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_proto_has_own_prop_3 ((ret S' full_descriptor_undef) : (specret full_descriptor))) : ext_expr) ((out_ter (S' : state) (false : res)) : out))
  ...
  | red_spec_call_object_proto_has_own_prop_3_not_undef :
      forall (S : state (* input *)) (S' : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_proto_has_own_prop_3 ((ret (T := full_descriptor) S' A) : (specret full_descriptor))) : ext_expr) ((out_ter (S' : state) (true : res)) : out))
  ...
  | red_spec_call_object_proto_prop_is_enumerable_4_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_proto_prop_is_enumerable_4 ((ret (T := full_descriptor) S0 full_descriptor_undef) : (specret full_descriptor))) : ext_expr) ((out_ter (S0 : state) (false : res)) : out))
  ...
  | red_spec_call_object_proto_prop_is_enumerable_4_not_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (A : attributes (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_object_proto_prop_is_enumerable_4 ((ret (T := full_descriptor) S0 A) : (specret full_descriptor))) : ext_expr) ((out_ter (S0 : state) (((attributes_enumerable (A : attributes)) : bool) : res)) : out))
  ...
  | red_spec_function_has_instance_3_eq :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (lo : object_loc (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_function_has_instance_3 (lo : object_loc) (lo : value)) : ext_expr) ((out_ter (S : state) (true : res)) : out))
  ...
  | red_spec_call_array_new_no_args :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (o : out),
        (* ========================================== *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_array_new_1 (nil : (list value))) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_construct_prealloc (prealloc_array : prealloc) (nil : (list value))) : ext_expr) (o : out))
  ...
  | red_spec_call_array_new_1 :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (args : (list value) (* input *)) (o : out),
        (* ========================================== *)
        (red_expr ((snd ((object_alloc S ((object_new prealloc_array_proto (("Array")%string)) : object)) : (object_loc * state))) : state) (C : execution_ctx) ((spec_call_array_new_2 ((fst ((object_alloc S ((object_new prealloc_array_proto (("Array")%string)) : object)) : (object_loc * state))) : object_loc) (args : (list value)) ((0%nat) : int)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_call_array_new_1 (args : (list value))) : ext_expr) (o : out))
  ...
  | red_spec_call_array_proto_pop_3_empty :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_array_proto_pop_3 (l : object_loc) ((ret S (0%Z)) : (specret int))) : ext_expr) (o : out))
  ...
  | red_spec_call_array_proto_pop_3_nonempty :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (lenuint32 : int (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_array_proto_pop_3 (l : object_loc) ((ret S lenuint32) : (specret int))) : ext_expr) (o : out))
  ...
  | red_spec_call_array_proto_push_3 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (args : (list value) (* input *)) (lenuint32 : int (* input *)) (o : out),
        ...
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_array_proto_push_3 (l : object_loc) (args : (list value)) ((ret S lenuint32) : (specret int))) : ext_expr) (o : out))
  ...
  | red_spec_construct_bool_1 :
      forall (O : object) (b : bool (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S : state) (C : execution_ctx) ((spec_construct_bool_1 ((out_ter (S : state) (b : res)) : out)) : ext_expr) ((out_ter ((snd ((object_alloc S ((object_with_primitive_value ((object_new prealloc_bool_proto (("Boolean")%string)) : object) b) : object)) : (object_loc * state))) : state) ((fst ((object_alloc S ((object_with_primitive_value ((object_new prealloc_bool_proto (("Boolean")%string)) : object) b) : object)) : (object_loc * state))) : res)) : out))
  ...
  | red_spec_call_bool_proto_to_string_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (b : bool (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_bool_proto_to_string_1 ((out_ter (S : state) (b : res)) : out)) : ext_expr) ((out_ter (S : state) (((convert_bool_to_string (b : bool)) : string) : res)) : out))
  ...
  | red_spec_construct_number_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (O : object) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_construct_number_1 ((out_ter (S : state) (v : res)) : out)) : ext_expr) ((out_ter ((snd ((object_alloc S ((object_with_primitive_value ((object_new prealloc_number_proto (("Number")%string)) : object) v) : object)) : (object_loc * state))) : state) ((fst ((object_alloc S ((object_with_primitive_value ((object_new prealloc_number_proto (("Number")%string)) : object) v) : object)) : (object_loc * state))) : res)) : out))
  ...
  | red_spec_build_error :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (vproto : value (* input *)) (vmsg : value (* input *)) (o : out),
        (* ========================================== *)
        (red_expr ((snd ((object_alloc S ((object_new vproto (("Error")%string)) : object)) : (object_loc * state))) : state) (C : execution_ctx) ((spec_build_error_1 ((fst ((object_alloc S ((object_new vproto (("Error")%string)) : object)) : (object_loc * state))) : object_loc) (vmsg : value)) : ext_expr) (o : out)) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_call_error_proto_to_string_6 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (sname : string (* input *)) (smsg : string (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_expr (S0 : state) (C : execution_ctx) ((spec_call_error_proto_to_string_6 (l : object_loc) (sname : string) ((out_ter (S : state) (smsg : res)) : out)) : ext_expr) ((out_ter (S : state) (((ifb ((sname : string) = (("")%string)) then smsg else (ifb ((smsg : string) = (("")%string)) then sname else (string_concat (string_concat sname ((": ")%string)) smsg))) : string) : res)) : out))
...
with red_spec : forall {T}, state (* input *) -> execution_ctx (* input *) -> ext_spec (* input *) -> (specret T) -> Prop :=
  ...
  | red_spec_expr_get_value_conv_1 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (K : (value -> ext_expr) (* input *)) (v : value (* input *)) (o1 : out) (y : (specret value)),
        ...
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_expr_get_value_conv_1 (K : (value -> ext_expr)) ((ret S v) : (specret value))) y)

  | red_spec_expr_get_value_conv_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_expr_get_value_conv_2 ((out_ter (S : state) (v : res)) : out)) (vret S v))
  ...
  | red_spec_list_expr_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (v : value (* input *)) (vs : (list value) (* input *)) (es : (list expr) (* input *)) (y : (specret (list value))),
        ...
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_list_expr_2 (vs : (list value)) ((ret S v) : (specret value)) (es : (list expr))) y)
  ...
  | red_spec_to_descriptor_object :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (y : (specret descriptor)),
        (* ========================================== *)
        (red_spec S C (spec_to_descriptor_1a (l : object_loc) ((descriptor_intro_empty : descriptor) : descriptor)) y) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_to_descriptor_1c :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (v : value (* input *)) (Desc : descriptor (* input *)) (y : (specret descriptor)),
        (* ========================================== *)
        (red_spec S C (spec_to_descriptor_2a (l : object_loc) (((descriptor_with_enumerable Desc (Some ((convert_value_to_boolean (v : value)) : bool))) : descriptor) : descriptor)) y) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_to_descriptor_2c :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (v : value (* input *)) (Desc : descriptor (* input *)) (y : (specret descriptor)),
        (* ========================================== *)
        (red_spec S C (spec_to_descriptor_3a (l : object_loc) (((descriptor_with_configurable Desc (Some ((convert_value_to_boolean (v : value)) : bool))) : descriptor) : descriptor)) y) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_to_descriptor_3c :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (v : value (* input *)) (Desc : descriptor (* input *)) (y : (specret descriptor)),
        (* ========================================== *)
        (red_spec S C (spec_to_descriptor_4a (l : object_loc) (((descriptor_with_value Desc (Some v)) : descriptor) : descriptor)) y) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_to_descriptor_4c :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (v : value (* input *)) (Desc : descriptor (* input *)) (y : (specret descriptor)),
        (* ========================================== *)
        (red_spec S C (spec_to_descriptor_5a (l : object_loc) (((descriptor_with_writable Desc (Some ((convert_value_to_boolean (v : value)) : bool))) : descriptor) : descriptor)) y) ->
        (* ------------------------------------------ *)
  ...
  | red_spec_to_descriptor_5c_ok :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (v : value (* input *)) (Desc : descriptor (* input *)) (y : (specret descriptor)),
        ((((is_callable S v) = false) : Prop) /\ ((v <> undef) : Prop)) ->
        (* ========================================== *)
        (red_spec S C (spec_to_descriptor_6a (l : object_loc) (((descriptor_with_get Desc (Some v)) : descriptor) : descriptor)) y) ->
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_to_descriptor_5c ((out_ter (S : state) (v : res)) : out) (l : object_loc) (Desc : descriptor)) y)
  ...
  | red_spec_to_descriptor_6c_ok :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (v : value (* input *)) (Desc : descriptor (* input *)) (y : (specret descriptor)),
        ((((is_callable S v) = false) : Prop) /\ ((v <> undef) : Prop)) ->
        (* ========================================== *)
        (red_spec S C (spec_to_descriptor_7 (l : object_loc) (((descriptor_with_set Desc (Some v)) : descriptor) : descriptor)) y) ->
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_to_descriptor_6c ((out_ter (S : state) (v : res)) : out) (l : object_loc) (Desc : descriptor)) y)
  ...
  | red_spec_object_get_own_prop_2_none :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_spec S C (spec_object_get_own_prop_2 (l : object_loc) (x : prop_name) (None : (option attributes))) (dret S full_descriptor_undef))
  ...
  | red_spec_object_get_own_prop_args_obj_1_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_args_obj_get_own_prop_1 (l : object_loc) (x : prop_name) ((ret S full_descriptor_undef) : (specret full_descriptor))) (ret S full_descriptor_undef))
  ...
  | red_spec_object_get_own_prop_args_obj_1_attrs :
      forall (lmap : object_loc) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (A : attributes (* input *)) (y : (specret full_descriptor)) (y1 : (specret full_descriptor)),
        ...
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_args_obj_get_own_prop_1 (l : object_loc) (x : prop_name) ((ret S (full_descriptor_some (A : attributes))) : (specret full_descriptor))) y)
  ...
  | red_spec_object_get_own_prop_args_obj_2_attrs :
      forall (o1 : out) (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (lmap : object_loc (* input *)) (A : attributes (* input *)) (Amap : attributes (* input *)) (y : (specret full_descriptor)),
        ...
        (* ------------------------------------------ *)
        (red_spec S C (spec_args_obj_get_own_prop_2 (l : object_loc) (x : prop_name) (lmap : object_loc) (A : full_descriptor) ((ret S0 (full_descriptor_some (Amap : attributes))) : (specret full_descriptor))) y)
  ...
  | red_spec_object_get_own_prop_args_obj_2_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (lmap : object_loc (* input *)) (A : attributes (* input *)) (y : (specret full_descriptor)),
        ...
        (* ------------------------------------------ *)
        (red_spec S C (spec_args_obj_get_own_prop_2 (l : object_loc) (x : prop_name) (lmap : object_loc) (A : full_descriptor) ((ret S0 full_descriptor_undef) : (specret full_descriptor))) y)
  ...
  | red_spec_object_get_own_prop_string_1_attrs :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (A : attributes (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_string_get_own_prop_1 (l : object_loc) (x : prop_name) ((ret S (full_descriptor_some (A : attributes))) : (specret full_descriptor))) (ret S (full_descriptor_some (A : attributes))))
  ...
  | red_spec_object_get_own_prop_string_1_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (y1 : (specret int)) (y : (specret full_descriptor)),
        ...
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_string_get_own_prop_1 (l : object_loc) (x : prop_name) ((ret S full_descriptor_undef) : (specret full_descriptor))) y)
  ...
  | red_spec_object_get_own_prop_string_2 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (k : int (* input *)) (o1 : out) (y : (specret full_descriptor)),
        ...
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_string_get_own_prop_2 (l : object_loc) (x : prop_name) ((ret S k) : (specret int))) y)
  ...
  | red_spec_object_get_own_prop_string_5 :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (s : string (* input *)) (idx : int (* input *)) (len : nat) (y : (specret full_descriptor)),
        ...
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_string_get_own_prop_5 (s : string) ((ret S idx) : (specret int))) y)
  ...
  | red_spec_lexical_env_get_identifier_ref_nil :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (x : prop_name (* input *)) (str : strictness_flag (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_spec S C (spec_lexical_env_get_identifier_ref (nil : lexical_env) (x : prop_name) (str : bool)) (ret S ((ref_create_value undef x str) : ref)))
  ...
  | red_spec_lexical_env_get_identifier_ref_cons_2_true :
      forall (S0 : state (* input *)) (C : execution_ctx (* input *)) (L : env_loc (* input *)) (lexs : lexical_env (* input *)) (x : prop_name (* input *)) (str : strictness_flag (* input *)) (S : state (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_lexical_env_get_identifier_ref_2 (L : env_loc) (lexs : lexical_env) (x : prop_name) (str : bool) ((out_ter (S : state) (true : res)) : out)) (ret S ((ref_create_env_loc L x str) : ref)))
  ...
  | red_spec_object_get_prop_2_not_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (A : attributes (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_object_get_prop_2 (l : object_loc) (x : prop_name) ((ret S (full_descriptor_some (A : attributes))) : (specret full_descriptor))) (ret S (full_descriptor_some (A : attributes))))
  ...
  | red_spec_object_get_prop_2_undef :
      forall (S0 : state (* input *)) (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)) (vproto : value) (y : (specret full_descriptor)),
        ...
        (* ------------------------------------------ *)
        (red_spec S0 C (spec_object_get_prop_2 (l : object_loc) (x : prop_name) ((ret S full_descriptor_undef) : (specret full_descriptor))) y)

  | red_spec_object_get_prop_3_null :
      forall (S : state (* input *)) (C : execution_ctx (* input *)) (l : object_loc (* input *)) (x : prop_name (* input *)),
        (* ========================================== *)
        (* ------------------------------------------ *)
        (red_spec S C (spec_object_get_prop_3 (l : object_loc) (x : prop_name) (null : value)) (dret S full_descriptor_undef))
